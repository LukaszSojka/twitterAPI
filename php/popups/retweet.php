...
?>
<div class="twits_retweet_popup">
	<div class="popup1">
		<a class="close_popup close_tweet">x</a>
		<div class="popup1_head1">Retweet this to your followers?</div>		
		<div class="popup1_body">
			<textarea class="retweet_text" name=""></textarea>
		</div>  	
		...
		<div class="popup1_button">
			<input type="submit" name="" value="Retweet" class="retweet_button" />
		</div>
	</div>
</div>
